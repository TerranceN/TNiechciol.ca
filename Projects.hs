  ...
  where
    ...
    content = do
        ...
        projectSection "Description" $ do
            ...
            screenshot "/images/particles_overview.png" "Particle System Overview"
            tag "p" [] $ text "Because the grid can experience acceleration, the process is more complex. Each intersection point is simulated as a particle as before, but in order to have multiple pull and push effects on the grid, an acceleration texture is generated in screen space, where each pixel represents the acceleration that a particle at that position would experience."
