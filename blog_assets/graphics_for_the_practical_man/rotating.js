var rotation_demo_x_basis = {x: 1, y: 0};
var rotation_demo_y_basis = {x: 0, y: 1};
...
var Module = (function() {
  ...
  function render(dt) {
    ...
    rotation_demo_x_basis = rotateBasis.xBasis;
    rotation_demo_y_basis = rotateBasis.yBasis;
    
    starWithBasis(rotateBasis);
