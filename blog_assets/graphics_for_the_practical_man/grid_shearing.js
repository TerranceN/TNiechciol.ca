var shearing_demo_x_basis = {x: 1, y: 0};
var shearing_demo_y_basis = {x: 0, y: 1};
...
var Module = (function() {
  ...
  function render() {
    ...
    */
    ...
    drawArrow({x: 0, y: 0}, shearing_demo_x_basis);
    drawArrow({x: 0, y: 0}, shearing_demo_y_basis);
